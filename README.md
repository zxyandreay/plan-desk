...
```text
release/
  PlanDesk_1.1.1_x64-setup.exe
  PlanDesk.exe
```

Use `PlanDesk_1.1.1_x64-setup.exe` when you want a normal Windows installer and Start Menu shortcut. Use `PlanDesk.exe` when you want to launch the built app directly from the release folder.
